...
| `wireform-edi`        | `EDI.Class`, `EDI.Encode`, `EDI.Decode`, `EDI.Derive`, `EDI.Encoding`, `EDI.Query`, `EDI.Validation`, `EDI.Value`, `EDI.X12`                                                                                                                                                                                                                                                                                                                                                                                                                 | Electronic Data Interchange segment streams with explicit delimiter syntax, X12 `ISA` delimiter inference, segment queries, generic validation, X12 envelope/control validation, 997 acknowledgement generation, and TH-derived typed segment records. |
