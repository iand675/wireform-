...
| `wireform-edi`        | `EDI.Class`, `EDI.Encode`, `EDI.Decode`, `EDI.Derive`, `EDI.Encoding`, `EDI.Value`                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Electronic Data Interchange segment streams with explicit delimiter syntax, X12 `ISA` delimiter inference, and TH-derived typed segment records. |
