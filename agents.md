...
| `wireform-edi`        | `EDI.Class`, `EDI.Encode`, `EDI.Decode`, `EDI.Derive`, `EDI.EDIFACT`, `EDI.Encoding`, `EDI.Query`, `EDI.Standard`, `EDI.Validation`, `EDI.Value`, `EDI.X12`                                                                                                                                                                                                                                                                                                                      | Electronic Data Interchange segment streams with explicit delimiter syntax; profiles/detection for UN/EDIFACT, X12, GS1 EDI, TRADACOMS, ODETTE, VDA, HL7, HIPAA, IATA Cargo-IMP, NCPDP SCRIPT, NCPDP Telecom, and EDIGAS; EDIFACT `UNA` / release-aware decode / UNB-UNZ validation; X12 `ISA` inference, control validation, 997 acknowledgement generation, and TH-derived typed segment records. |
